...
void RCCInitialize(void)
{
	...
	/*W5x00 SPI initialize*/
#if defined(SPI_Arduino)
	RCC_APB2PeriphClockCmd(W5x00_SPI_RCC, ENABLE);
#else
	RCC_APB1PeriphClockCmd(W5x00_SPI_RCC, ENABLE);
#endif
}
...
void gpioInitialize(void)
{
	...
	/* GPIO for W5x00 initialize */

	/*For SPI*/
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_InitStructure.GPIO_Pin = W5x00_SPI_SCK_PIN | W5x00_SPI_MOSI_PIN | W5x00_SPI_MISO_PIN;
	GPIO_Init(W5x00_SPI_PORT, &GPIO_InitStructure);


	/*For CS*/
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_InitStructure.GPIO_Pin = W5x00_CS_PIN;
	GPIO_Init(W5x00_CS_PORT, &GPIO_InitStructure);
...
void spiInitailize(void)
{
	...
	SPI_Init(W5x00_SPI, &SPI_InitStructure);

	SPI_Cmd(W5x00_SPI,ENABLE);
}
